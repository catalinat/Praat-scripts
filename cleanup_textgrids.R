# This script goes through a TextGrid and removes all the text from tier number 5 leaving all boundaries in
...
fix_textgrids_in_directory("/Users/catalina/Desktop/UoM-G-Drive/Pitjantjara_ConverbProsody/data-30.08.2021/Ana3-batches/Batch 13/new")
