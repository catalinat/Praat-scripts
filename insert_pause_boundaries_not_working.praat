...
form "Give the parameters for pause analysis"
   ...
   integer: "Starting_time_(seconds)", 0
   integer: "Finishing_time_(0=all)", 0
   comment: "The following criteria define a pause:"
   positive: "positive Minimum_duration_(seconds)", 0.39
   positive: "positive Maximum_intensity_(dB)", 63
   comment: "Give the intensity analysis parameters:"
	positive: "positive Minimum_pitch_(Hz)", 100
	integer: "Time_step_(0=auto)", 0
   comment: "Give the window size for the intensity analyses (smaller window requires less memory):"
	positive: "positive Window_size_(seconds)", 20
   ...
   sentence: "directory", "'baseDir$'"
   sentence: "fileName", "Kabine_1_0X.wav"
   endform
